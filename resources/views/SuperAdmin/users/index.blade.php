...
@section('content')
    <div class="mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="h-screen pb-10">
            <div class="h-full py-5 sm:py-5 mb-10 bg-white rounded-lg shadow px-5 sm:px-7">
                <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-6">
                    <input type="text" placeholder="Search for users..."
                        class="w-full sm:w-64 h-10 p-3 text-sm text-gray-500 bg-gray-100 border border-gray-200 rounded-lg focus:ring-2 focus:outline-none focus:ring-blue-500"
                ...
                <div class="w-full overflow-x-auto rounded-lg my-7">
                    <div class="min-w-full">
                        <table id="user_table" class="min-w-full rounded-lg table-auto user_table">
